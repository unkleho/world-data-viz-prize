...
export const insights = [
	{
		...
		title: 'Introduction',
		content:
			"What is good government? We'll try to answer this question with data.",
	},
	{
		query: {
			x: 8,
		...
		title: 'Introduction',
		content: 'An obvious way to measure it is by GDP per capita and happiness.',
	},
	{
		query: {
			x: 8,
		...
		title: 'Introduction',
		content: 'The Human Development index is closely related too.',
	},
	{
		query: {
			x: 8,
		...
		title: 'Introduction',
		content: 'The GINI Index (inequality, lower is better) too.',
	},
	{
		query: {
			x: 8,
		...
		title: 'Introduction',
		content: 'A few outliers, including Singapore...',
	},
	{
		query: {
			x: 8,
	...
	},
	{
		...
		content:
			'Clear correlation here, especially over 14 years of education, GDP per Capita increases significantly',
	},
	{
		query: {
			x: 8,
		...
		content:
			'Looks like more correlation for European countries. North American countries like Costa Rica, although they have lower GDP per Capita, their Happy Planet Index is high.',
		// Luxembourg scores lowly on HPI.
	},
];
